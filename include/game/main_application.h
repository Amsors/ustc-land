...
class MainApplication final: public nanogui::Screen, public Tickable {
public:
    MainApplication();
...
private:
    ...
    Bar *const welcomeBar, *const listBar, *const infoBar; // HUD
    bool playing = false;
    int ticks = 0;
    double lastFrame = 0., timeProgress = 0.;
};
